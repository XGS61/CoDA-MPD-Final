"""H7.15 Strong-all ordered appearance transform for SliceEqOcc-OAAC."""

import torch


OAAC_SCALE = 1.25
LOG_GAMMA_RANGE = (-0.25, 0.25)
LOG_CONTRAST_RANGE = (-0.1875, 0.1875)
BRIGHTNESS_SPAN_RANGE = (-0.125, 0.125)
