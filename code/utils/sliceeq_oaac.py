"""Ordered, coordinate-preserving appearance transform for SliceEqOcc-OAAC."""

import torch


LOG_GAMMA_RANGE = (-0.20, 0.20)
LOG_CONTRAST_RANGE = (-0.15, 0.15)
BRIGHTNESS_SPAN_RANGE = (-0.10, 0.10)
