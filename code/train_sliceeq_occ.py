"""Fractional-occupancy SliceEq on the locked PROMISE12 training recipe.

This is an independent successor to ``train_sliceeq.py``. After the inherited
1k identity warmup it preserves the original labeled center anchor, adds one
exact-GT re-acquired labeled view, and supervises both labeled and unlabeled
re-acquired views with the full slice-profile-weighted tissue occupancy.
"""
