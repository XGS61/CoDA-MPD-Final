"""Inference entry for BMER checkpoints.

BMER has no inference-time component, so this file deliberately reuses the current
CoDA/baseline evaluator while changing only the default experiment name.
"""
...
parser.add_argument('--auto_find_checkpoint', type=str, default='True',
                    choices=['True', 'False', 'true', 'false', '1', '0',
                             'yes', 'no'])
