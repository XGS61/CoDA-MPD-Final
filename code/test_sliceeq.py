"""Inference entry for SliceEq checkpoints.

SliceEq has no inference-time component. Reuse the current evaluator with the
SliceEq experiment identity and broad checkpoint fallback disabled.
"""
...
def _strict_load_model_weight(evaluator, net, model_path, device):
    """Load only an exactly compatible SliceEq state dictionary."""
